...
function GrafikVariasi(){
  function GrafikRegresi1(){
    const dataPengukuranUdara = datasets('Pengukuran Udara','scatter',DataMentahW2.beban1.udara.t,DataW2.beban1.udara.Amplitudo,'orange','orange',);
    const dataRegresiUdara = datasets('Regresi Udara','line', DataW2.beban1.udara.regPlot.t,DataW2.beban1.udara.regPlot.A, 'red', 'red',)
    const dataPengukuranAir = datasets('Pengukuran Air','scatter',DataMentahW2.beban1.air.t,DataW2.beban1.air.Amplitudo,'green','green',)
    const dataRegresiAir = datasets('Regresi Air','line', DataW2.beban1.air.regPlot.t,DataW2.beban1.air.regPlot.A, 'blue', 'blue',)
  ...
  function GrafikPerbandingan1(){
    ...
    const PlotGrafik = <PlotGraph title='Grafik Osilasi Pegas pada Beban 1' titleX={'Waktu (s)'} titleY={'Amplitude (m)'} datasets={[dataRegresiAir, DataOsilasiAir, dataRegresiUdara,DataOsilasiUdara, ]}/>
    return  PlotGrafik
  }

  function GrafikRegresi2(){
    const dataPengukuranUdara = datasets('Pengukuran Udara','scatter',DataMentahW2.beban2.udara.t,DataW2.beban2.udara.Amplitudo,'orange','orange',)
    const dataRegresiUdara = datasets('Regresi Udara','line', DataW2.beban2.udara.regPlot.t,DataW2.beban2.udara.regPlot.A, 'red', 'red',)
    const dataPengukuranAir = datasets('Pengukuran Air','scatter',DataMentahW2.beban2.air.t,DataW2.beban2.air.Amplitudo,'green','green',)
    const dataRegresiAir = datasets('Regresi Air','line', DataW2.beban2.air.regPlot.t, DataW2.beban2.air.regPlot.A, 'blue', 'blue',)

    const PlotGrafik = <PlotGraph title='Grafik Regresi pada Beban 2' titleX={'Waktu (s)'} titleY={'Amplitude (m)'} datasets={[dataRegresiUdara,dataRegresiAir,dataPengukuranUdara,dataPengukuranAir]}/>
    return  PlotGrafik
  }
