...
// Cari Rata2 nya
const rata2lt1 = parseFloat(mean(fluxData.lt1).toFixed(3))
const rata2lt2 = parseFloat(mean(fluxData.lt2).toFixed(3))
const rata2lt3 = parseFloat(mean(fluxData.lt3).toFixed(3))
const rata2lt4 = parseFloat(mean(fluxData.lt4).toFixed(3))
